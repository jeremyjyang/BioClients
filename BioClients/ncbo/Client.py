...
"""
###
import sys,os,argparse,re,yaml,json,logging,time
#
from .. import ncbo
...
if __name__=='__main__':
  parser = argparse.ArgumentParser(description='NCBO REST API client utility')
  ops = ['recommendOntologies']
  parser.add_argument("op", choices=ops, help='OPERATION')
  parser.add_argument("--i", dest="ifile", help="input terms")
  parser.add_argument("--o", dest="ofile", help="output (TSV)")
  parser.add_argument("--term", help='input term')
  ...
  if args.ifile:
    ...
    logging.info(f"input terms: {len(terms)}")
  elif args.term:
    terms = [args.term]
  ...
  if args.op == 'recommendOntologies':
    ncbo.Utils.RecommendOntologies(base_url, params['API_KEY'], terms, fout)
